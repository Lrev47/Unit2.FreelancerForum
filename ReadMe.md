...
Calculate the average of all prices, display in span -done
Display the objects from the main array in the html -

Add an object to the main array from another array -
